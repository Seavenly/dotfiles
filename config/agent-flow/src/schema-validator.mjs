...
const CONTRACT_FILES = new Map([
  ...
  ["agent-flow.feature/v1", "agent-flow.feature.v1.schema.json"],
  ["agent-flow.spike/v1", "agent-flow.spike.v1.schema.json"],
  ["agent-flow.spike-result/v1", "agent-flow.spike-result.v1.schema.json"],
  ["agent-flow.epic/v1", "agent-flow.epic.v1.schema.json"],
  ["agent-flow.epic-state/v1", "agent-flow.epic-state.v1.schema.json"],
  ["agent-flow.stack-plan/v1", "agent-flow.stack-plan.v1.schema.json"],
  ["agent-flow.stack-state/v1", "agent-flow.stack-state.v1.schema.json"],
  ["agent-flow.delivery/v1", "agent-flow.delivery.v1.schema.json"],
  ["agent-flow.delivery-state/v1", "agent-flow.delivery-state.v1.schema.json"],
  [
